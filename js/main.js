...
(function($, document, window, undefined) {
    ...
    $.fn.pagepiling = function(custom) {
        ...
        PP.destroy = function(all) {
            ...
            $document.off('click touchstart', '#pp-nav a').off('mouseenter', '#pp-nav li').off('mouseleave', '#pp-nav li').off('mouseover', options.normalScrollElements).off('mouseout', options.normalScrollElements);
            if (all) {
                destroyStructure();
            }
        };
    ...
    if (document.getElementById("pagepiling")) {
        ...
        function initPaging() {
            ...
            function progressBar(index) {
                ...
                progressBar.style.width = (100 / 6) * index + "%";
            }
    ...
    document.addEventListener('DOMContentLoaded', function() {
        var n, i = new(function t() {
            ...
            !(function(t, e) {
                ...
                (n.container = document.createElement('div')), n.container.classList.add('custom-cursor'), document.body.appendChild(n.container);
            }), e(this, 'initListeners', function() {
                window.addEventListener('mousemove', n.trackPosition);
            }), e(this, 'add', function(t) {
                (new Image().src = t.dataset.cursor), t.addEventListener('mousemove', n.show), t.addEventListener('mouseleave', n.hide);
            }), e(this, 'show', function(t) {
                n.isActive || (clearTimeout(n.timer), (n.isActive = !0), (n.container.style.backgroundImage = 'url('.concat(t.currentTarget.dataset.cursor, ')')), n.container.classList.add('active'));
                ...
                (n.container.style.top = ''.concat(event.clientY, 'px')), (n.container.style.left = ''.concat(event.clientX, 'px'));
        ...
        if (document.querySelector('.section__services')) {
            var i = function() {
                ...
                r = function e(i, o) {
                    ...
                    t(this, e), n(this, 'onClick', function() {
                        ...
                        r.isOpened || (e.active && e.active.close(), (r.isOpened = !0), (e.active = r), r.$refs.control.classList.add('active'), r.$refs.content.classList.add('active'), (r.$refs.content.style.height = ''.concat(r.$refs.content.scrollHeight, 'px')));
                    }), n(this, 'close', function() {
                        r.isOpened && ((r.isOpened = !1), (r.$refs.content.style.height = ''.concat(r.$refs.content.scrollHeight, 'px')), getComputedStyle(r.$refs.content).height, (r.$refs.content.style.height = '0px'), r.$refs.control.classList.remove('active'), r.$refs.content.classList.remove('active'));
                    }), n(this, 'destroy', function() {
                        r.$refs.control.removeEventListener('click', r.onClick), r.$refs.content.removeEventListener('transitionend', r.onAnimationEnd), r.$refs.content.removeAttribute('style'), r.$refs.control.classList.remove('active'), r.$refs.content.classList.remove('active');
                    }), (this.isOpened = !1), (this.$refs = {
                        control: i,
                        content: o
                    }), this.$refs.control.addEventListener('click', this.onClick), this.$refs.content.addEventListener('transitionend', this.onAnimationEnd), e.inited.push(this);
                };
            ...
            var c = function e(i, o) {
                ...
                t(this, e), n(this, 'open', function() {
                    r.isOpened || (e.active && e.active.close(), (r.isOpened = !0), (e.active = r), r.$refs.control.classList.add('active'), r.$refs.content.classList.add('active'));
                }), n(this, 'close', function() {
                    r.isOpened && ((r.isOpened = !1), r.$refs.control.classList.remove('active'), r.$refs.content.classList.remove('active'));
                }), n(this, 'destroy', function() {
                    r.$refs.control.removeEventListener('mouseover', r.open), r.$refs.control.classList.remove('active'), r.$refs.content.classList.remove('active');
                }), (this.isOpened = !1), (this.$refs = {
                    control: i,
                    content: o
